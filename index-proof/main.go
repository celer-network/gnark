...
func main() {
	...
	ccs, err := frontend.Compile(targetCurve.ScalarField(), r1cs.NewBuilder, &core.IndexCheckCircuit{})
	if err != nil {
	...
	witness, _ := frontend.NewWitness(&assignment, targetCurve.ScalarField())
