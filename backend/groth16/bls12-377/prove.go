...
func ProveOnlyWithSolver(r1cs *cs.R1CS, pk *ProvingKey, fullWitness witness.Witness, opts ...backend.ProverOption) error {
	...
	if r1cs.CommitmentInfo.Is() {
		fmt.Printf("this circuit has r1cs CommitmentInfo \n")
