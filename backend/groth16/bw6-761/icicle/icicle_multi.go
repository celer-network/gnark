...
import (
	...
	icicle_bw6761 "github.com/ingonyama-zk/icicle/v2/wrappers/golang/curves/bw6761"
	icicle_g2 "github.com/ingonyama-zk/icicle/v2/wrappers/golang/curves/bw6761/g2"
	icicle_msm "github.com/ingonyama-zk/icicle/v2/wrappers/golang/curves/bw6761/msm"
	icicle_ntt "github.com/ingonyama-zk/icicle/v2/wrappers/golang/curves/bw6761/ntt"
	icicle_vecops "github.com/ingonyama-zk/icicle/v2/wrappers/golang/curves/bw6761/vecOps"
...
func (pk *ProvingKey) setupDevicePointersOnMulti(deviceIds []int, freePk bool) error {
	...
	icicle_cr.RunOnDevice(deviceIds[0], func(args ...any) {
		...
		icicle_bw6761.FromMontgomery(&pk.DenDevice)
		copyDenDone <- true
	})
	...
	icicle_cr.RunOnDevice(deviceIds[1], func(args ...any) {
		...
		icicle_bw6761.AffineFromMontgomery(&pk.G1Device.A)
		copyADone <- true
	})
	/*************************     B      ***************************/
	...
	icicle_cr.RunOnDevice(deviceIds[3], func(args ...any) {
		...
		icicle_bw6761.AffineFromMontgomery(&pk.G1Device.B)
		copyBDone <- true
	})
	/*************************     K      ***************************/
	...
	icicle_cr.RunOnDevice(deviceIds[4], func(args ...any) {
		...
		icicle_bw6761.AffineFromMontgomery(&pk.G1Device.K)
		copyKDone <- true
	})
	/*************************     Z      ***************************/
	...
	icicle_cr.RunOnDevice(deviceIds[0], func(args ...any) {
		...
		icicle_bw6761.AffineFromMontgomery(&pk.G1Device.Z)
		copyZDone <- true
	})
	/*************************  End G1 Device Setup  ***************************/
	<-copyDenDone
...
func ProveOnMulti(r1cs *cs.R1CS, pk *ProvingKey, fullWitness witness.Witness, opts ...backend.ProverOption) (*groth16_bw6761.Proof, error) {
	...
	computeBS1 := func(deviceId int) error {
		...
		icicle_bw6761.FromMontgomery(&wireValuesBDevice)
	...
	computeAR1 := func(deviceId int) error {
		...
		icicle_bw6761.FromMontgomery(&wireValuesADevice)
	...
	computeKrs := func(deviceId int) error {
		...
		icicle_bw6761.FromMontgomery(&wireValuesDevice)
	...
	computeKrs2 := func(deviceId int) error {
		...
		resKrs2_1 := make(icicle_core.HostSlice[icicle_bw6761.Projective], 1)
		resKrs2_2 := make(icicle_core.HostSlice[icicle_bw6761.Projective], 1)
	...
	computeBS2 := func(deviceId int) error {
		...
		icicle_bw6761.FromMontgomery(&wireValuesBDeviceForG2)
...
func computeHOnDevice(a, b, c []fr.Element, pk *ProvingKey, log zerolog.Logger, deviceId int) icicle_core.DeviceSlice {
	...
	icicle_bw6761.FromMontgomery(&aDevice)
